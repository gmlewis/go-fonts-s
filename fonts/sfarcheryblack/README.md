...
import (
  ...
  _ "github.com/gmlewis/go-fonts-s/fonts/sfarcheryblack"
)

func main() {
  // ...
  xPos, yPos, xScale, yScale := 0.0, 0.0, 1.0, 1.0
  message := "Sample from sfarcheryblack"
  render, err := fonts.Text(xPos, yPos, xScale, yScale, message, "sfarcheryblack", &fonts.Center)
  if err != nil {
    log.Fatal(err)
  }
