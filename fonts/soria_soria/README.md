...
import (
  ...
  _ "github.com/gmlewis/go-fonts-s/fonts/soria_soria"
)

func main() {
  // ...
  xPos, yPos, xScale, yScale := 0.0, 0.0, 1.0, 1.0
  message := "Sample from soria_soria"
  render, err := fonts.Text(xPos, yPos, xScale, yScale, message, "soria_soria", &fonts.Center)
  if err != nil {
    log.Fatal(err)
  }
