...
import (
  ...
  _ "github.com/gmlewis/go-fonts-s/fonts/shortstack"
)

func main() {
  // ...
  xPos, yPos, xScale, yScale := 0.0, 0.0, 1.0, 1.0
  message := "Sample from shortstack"
  render, err := fonts.Text(xPos, yPos, xScale, yScale, message, "shortstack", &fonts.Center)
  if err != nil {
    log.Fatal(err)
  }
