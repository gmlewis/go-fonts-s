...
import (
  ...
  _ "github.com/gmlewis/go-fonts-s/fonts/solveigdemibold"
)

func main() {
  // ...
  xPos, yPos, xScale, yScale := 0.0, 0.0, 1.0, 1.0
  message := "Sample from solveigdemibold"
  render, err := fonts.Text(xPos, yPos, xScale, yScale, message, "solveigdemibold", &fonts.Center)
  if err != nil {
    log.Fatal(err)
  }
