...
import (
  ...
  _ "github.com/gmlewis/go-fonts-s/fonts/spacemono_bold"
)

func main() {
  // ...
  xPos, yPos, xScale, yScale := 0.0, 0.0, 1.0, 1.0
  message := "Sample from spacemono_bold"
  render, err := fonts.Text(xPos, yPos, xScale, yScale, message, "spacemono_bold", &fonts.Center)
  if err != nil {
    log.Fatal(err)
  }
