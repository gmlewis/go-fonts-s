...
import (
  ...
  _ "github.com/gmlewis/go-fonts-s/fonts/solveigdisplay"
)

func main() {
  // ...
  xPos, yPos, xScale, yScale := 0.0, 0.0, 1.0, 1.0
  message := "Sample from solveigdisplay"
  render, err := fonts.Text(xPos, yPos, xScale, yScale, message, "solveigdisplay", &fonts.Center)
  if err != nil {
    log.Fatal(err)
  }
