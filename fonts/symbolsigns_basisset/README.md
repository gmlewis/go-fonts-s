...
import (
  ...
  _ "github.com/gmlewis/go-fonts-s/fonts/symbolsigns_basisset"
)

func main() {
  // ...
  xPos, yPos, xScale, yScale := 0.0, 0.0, 1.0, 1.0
  message := "Sample from symbolsigns_basisset"
  render, err := fonts.Text(xPos, yPos, xScale, yScale, message, "symbolsigns_basisset", &fonts.Center)
  if err != nil {
    log.Fatal(err)
  }
