...
import (
  ...
  _ "github.com/gmlewis/go-fonts-s/fonts/shojumaru_regular"
)

func main() {
  // ...
  xPos, yPos, xScale, yScale := 0.0, 0.0, 1.0, 1.0
  message := "Sample from shojumaru_regular"
  render, err := fonts.Text(xPos, yPos, xScale, yScale, message, "shojumaru_regular", &fonts.Center)
  if err != nil {
    log.Fatal(err)
  }
