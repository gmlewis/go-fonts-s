...
import (
  ...
  _ "github.com/gmlewis/go-fonts-s/fonts/sfarcheryblacksc"
)

func main() {
  // ...
  xPos, yPos, xScale, yScale := 0.0, 0.0, 1.0, 1.0
  message := "Sample from sfarcheryblacksc"
  render, err := fonts.Text(xPos, yPos, xScale, yScale, message, "sfarcheryblacksc", &fonts.Center)
  if err != nil {
    log.Fatal(err)
  }
