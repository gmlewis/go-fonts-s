...
import (
  ...
  _ "github.com/gmlewis/go-fonts-s/fonts/stardosstencil_bold"
)

func main() {
  // ...
  xPos, yPos, xScale, yScale := 0.0, 0.0, 1.0, 1.0
  message := "Sample from stardosstencil_bold"
  render, err := fonts.Text(xPos, yPos, xScale, yScale, message, "stardosstencil_bold", &fonts.Center)
  if err != nil {
    log.Fatal(err)
  }
