...
import (
  ...
  _ "github.com/gmlewis/go-fonts-s/fonts/stmarie_thin"
)

func main() {
  // ...
  xPos, yPos, xScale, yScale := 0.0, 0.0, 1.0, 1.0
  message := "Sample from stmarie_thin"
  render, err := fonts.Text(xPos, yPos, xScale, yScale, message, "stmarie_thin", &fonts.Center)
  if err != nil {
    log.Fatal(err)
  }
